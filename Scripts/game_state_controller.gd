...
func change_gui(gui_name: String, load_type: Global.SceneChange = Global.SceneChange.Replace) -> void:
	if current_gui_scene:
		if load_type == Global.SceneChange.Replace:
...
func change_world(world_name: String, load_type: Global.SceneChange = Global.SceneChange.Replace) -> void:
